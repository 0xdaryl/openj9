...
void TR_LocalRecompilationCounters::modifyTrees()
   ...
   if (debug("traceCounters"))
      ...
      comp()->dumpMethodTrees(comp()->getLogger(), "Trees before Local Recompilation Counters");
      }
   ...
   if (debug("traceCounters"))
      {
      comp()->dumpMethodTrees(comp()->getLogger(), "Trees after Local Recompilation Counters");
      }
   }
...
void TR_GlobalRecompilationCounters::modifyTrees()
   ...
   if (debug("traceCounters"))
      ...
      comp()->dumpMethodTrees(comp()->getLogger(), "Trees before Global Recompilation Counters");
      }
   ...
   if (debug("traceCounters"))
      {
      comp()->dumpMethodTrees(comp()->getLogger(), "Trees after Global Recompilation Counters");
      }
   }
