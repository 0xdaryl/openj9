...
void
TR_Debug::printByteCodeStack(
      TR::Logger *log,
      int32_t parentStackIndex,
   ...
   if (!_comp->fej9()->isAOT_DEPRECATED_DO_NOT_USE())
      ...
      if (parentStackIndex == -1)
         ...
         printByteCodeStack(log, site._byteCodeInfo.getCallerIndex(), site._byteCodeInfo.getByteCodeIndex(), indent);
      ...
      j9bcutil_dumpBytecodes(((TR_J9VMBase *)_comp->fej9())->_portLibrary,
                             ...
                             byteCodeIndex, byteCodeIndex, flags, bcPrintFunc, log, indent);
