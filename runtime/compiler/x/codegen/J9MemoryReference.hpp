...
#ifndef J9_X86_MEMORY_REFERENCE_INCL
#define J9_X86_MEMORY_REFERENCE_INCL
...
#define J9_MEMORY_REFERENCE_CONNECTOR
   namespace J9 { namespace X86 { class MemoryReference; } }
   namespace J9 {typedef J9::X86::MemoryReference MemoryReferenceConnector; }
#else
   #error J9::X86::MemoryReference expected to be a primary connector, but a J9 connector is already defined
#endif
