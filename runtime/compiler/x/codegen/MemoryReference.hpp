...
public:
   ...
   MemoryReference(
      ...
      uint8_t s,
      TR::CodeGenerator *cg) :
         J9::MemoryReferenceConnector(br, sr, ir, s, cg) {}
   ...
   MemoryReference(
      ...
      uint8_t s,
      TR::CodeGenerator *cg) :
         J9::MemoryReferenceConnector(br, ir, s, cg) {}
   ...
   MemoryReference(
      intptr_t disp,
      TR::CodeGenerator *cg) :
         J9::MemoryReferenceConnector(disp, cg) {}
   ...
   MemoryReference(
      ...
      intptr_t disp,
      TR::CodeGenerator *cg) :
         J9::MemoryReferenceConnector(br, ir, s, disp, cg) {}

   MemoryReference(
      TR::X86DataSnippet *cds,
      TR::CodeGenerator *cg) :
         J9::MemoryReferenceConnector(cds, cg) {}

   MemoryReference(
      TR::LabelSymbol *label,
      TR::CodeGenerator *cg) :
         J9::MemoryReferenceConnector(label, cg) {}

   MemoryReference(
      TR::Node *rootLoadOrStore,
      TR::CodeGenerator *cg,
      bool canRematerializeAddressAdds) :
         J9::MemoryReferenceConnector(rootLoadOrStore, cg, canRematerializeAddressAdds) {}

   MemoryReference(
      TR::SymbolReference *symRef,
      TR::CodeGenerator *cg) :
         J9::MemoryReferenceConnector(symRef, cg) {}

   MemoryReference(
      TR::SymbolReference *symRef,
      intptr_t displacement,
      TR::CodeGenerator *cg) :
         J9::MemoryReferenceConnector(symRef, displacement, cg) {}
