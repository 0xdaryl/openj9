...
class OMR_EXTENSIBLE TreeEvaluator: public J9::TreeEvaluator
   ...
   static void inlineRecursiveMonitor(TR::Node *node, TR::CodeGenerator *cg, TR::LabelSymbol *fallThruLabel, TR::LabelSymbol *fallThruWithCounterUpdateLabel, TR::LabelSymbol *snippetLabel, TR::LabelSymbol *JITMonitorEnterSnippetLabel, TR::Register *objectReg, int lwoffset, TR::LabelSymbol *snippetRestartLabel, bool reservingLock);
