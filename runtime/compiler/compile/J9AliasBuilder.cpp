...
J9::AliasBuilder::methodAliases(TR::SymbolReference *symRef)
   ...
   while (true)
      ...
      if (id >= 0)
         ...
         if (comp()->getOption(TR_TraceAliases) && comp()->getLoggingEnabled())
            ...
            _userFieldMethodDefAliases[id]->print(comp()->getLogger(), comp());
            traceMsg(comp(), "\n");
            }
            ...
            while (immutableClassInfoElem)
               ...
               if ((immutableClassNameLen == clazzNameLen) &&
                  ...
                  if (comp()->getOption(TR_TraceAliases) && comp()->getLoggingEnabled())
                     ...
                     symrefsToInclude->print(comp()->getLogger(), comp());
                     traceMsg(comp(), "\n");
                     }
                  if (allocatedResult)
   ...
   if (comp()->getOption(TR_TraceAliases) && comp()->getLoggingEnabled())
      ...
      defaultMethodDefAliasesWithoutImmutable().print(comp()->getLogger(), comp());
      traceMsg(comp(), "\n");
      }
