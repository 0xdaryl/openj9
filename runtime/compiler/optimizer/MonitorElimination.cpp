...
int32_t TR::MonitorElimination::perform()
   ...
   if (trace())
      ...
      traceMsg(
         ...
         comp()->signature());
      comp()->dumpMethodTrees(comp()->getLogger(), "Trees before Monitor Elimination");
      }
   ...
   if (trace())
      {
      comp()->dumpMethodTrees(comp()->getLogger(), "Trees after Monitor Elimination");
...
void TR::MonitorElimination::coarsenMonitorRanges()
   ...
   if (trace())
      ...
      _guardedVirtualCallBlocks->print(comp()->getLogger(), comp());
      traceMsg(comp(), "\n");
      }
   ...
   while (!_monexitWorkList->isEmpty())
      ...
      *_temp = *successors;
      ...
      if (trace())
         ...
         _temp->print(comp()->getLogger(), comp());
         traceMsg(comp(), "\n");
         }
      ...
      if (_specialBlockInfo.getSize() > numSpecialBlocks)
         ...
         *_inclusiveIntersection |= *_matchingMonentBlocks;
         ...
         if (trace())
            ...
            _closureIntersection->print(comp()->getLogger(), comp());
            traceMsg(comp(), "\n");
            }
   ...
   while (succs.hasMoreElements())
      ...
      if (_monentBlockInfo[nextSucc] != -1 &&
         ...
         if (trace())
            ...
            predecessors->print(comp()->getLogger(), comp());
            traceMsg(comp(), "\n");
            }
